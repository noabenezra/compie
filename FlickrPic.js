...
.controller('AppCtrl', function($scope, $mdDialog) {debugger;
    $scope.status = '  ';
    ...
    $(document).ready(function () {   debugger;
        $("md-button").click(function () {   debugger;
            $.getJSON(apiFlicker, function (result) {   debugger;
    ...
    $scope.showAdvanced = function(ev) {
      $mdDialog.show({
        ...
        templateUrl: 'GitHub/compie/Dialog.html',
